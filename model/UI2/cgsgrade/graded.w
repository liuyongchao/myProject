...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:232px;left:505px;"> 
  <div component="$UI/system/components/justep/data/data" autoLoad="false" xid="gradedData" idColumn="UUID">
  ...
  <column label="提交时间" name="PU_UP_TIME" type="DateTime" xid="xid4"></column>
  <column label="总分" name="SUM_VALUE" type="String" xid="xid5"></column></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content  x-scroll-view" xid="content1" _xid="C715883247600001F846DE6A40C227B0" style="bottom: 0px;"><div class="x-scroll" component="$UI/system/components/justep/scrollView/scrollView" xid="scrollView1" style="z-index:auto;" autoPullUp="true" onPullDown="false">
   <div class="x-scroll-content" xid="div2">
    
    
    
    <div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="gradedData" autoLoad="true">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   <div class="x-col x-col-fixed clearfix" xid="col1" style="width:85px;text-align:center;background-color:#808080;color:#FFFFFF;">
    <label xid="label2" style="width:auto;">项目名称</label></div> 
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   <div class="x-col x-col-fixed clearfix" xid="col3" style="width:85px;text-align:center;background-color:#808080;color:#FFFFFF;">
    <label xid="label1" style="width:auto;">阶段名称</label></div> 
   ...
   <div class="x-col x-col-fixed" xid="col40" style="width:85px;text-align:center;background-color:#808080;color:#FFFFFF;">
    <label xid="label19">提交时间</label></div> 
   <div class="x-col" xid="col39" style="background-color:#C0C0C0;">
    <div component="$UI/system/components/justep/output/output" class="x-output" xid="output19" style="font-weight:bold;text-align:center;" bind-ref='ref("PU_UP_TIME")' format="YYYY-MM-DD"></div>
  </div> 
   <div class="x-col x-col-fixed" xid="col33" style="width:85px;text-align:center;background-color:#808080;color:#FFFFFF;">
    <label xid="label20">总分</label></div> 
   <div class="x-col" xid="col38" style="background-color:#C0C0C0;">
    <div component="$UI/system/components/justep/output/output" class="x-output" xid="output20" style="font-weight:bold;text-align:center;" bind-ref='ref("SUM_VALUE")'></div></div> </div>
  </li>
  </ul> 
  </div></div> 
   </div></div>
...
<span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver1" onReceive="windowReceiver1Receive"></span>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog" src="$UI/cgsgrade/gradeddetail.w"></span></div>