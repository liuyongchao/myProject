...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div class="x-contents-content" xid="serachContent"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="windowContainer3" src="$UI/library/searchBook.w"></div></div>
  <div class="x-contents-content" xid="myContent"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="windowContainer2" src="$UI/library/myBook.w"></div></div>
  <div class="x-contents-content" xid="newContent"><div component="$UI/system/components/justep/windowContainer/windowContainer" class="x-window-container" xid="windowContainer1" src="$UI/library/newBook.w"></div></div>
  <div class="x-contents-content" xid="otherContent"></div></div></div>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default btn-icon-top" label="其它" xid="otherBtn" icon="glyphicon glyphicon-comment" target="otherContent">
   ...
   <span xid="span5">其它</span></a></div></div></div></div>