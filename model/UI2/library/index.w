...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row3">
   <div class="x-col" xid="col7" style="position:relative;margin:10px 5px;background-color:#FFD675;">
   ...
   <div class="x-col" xid="col17" style="position:relative;margin:10px 5px;background-color:#399179;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row5">
   ...
   <div class="x-col" xid="col21" style="position:relative;margin:10px 5px;background-color:#978B7C;">
